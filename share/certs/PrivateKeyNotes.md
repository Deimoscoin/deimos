...
unlocked to sign the DeiMos-Qt.app bundle.
...
allowing somebody to distribute a DeiMos-Qt.app or deimos-qt-setup.exe with a valid
...
that the deimos-qt.exe file inside the installer had not been tampered with.
