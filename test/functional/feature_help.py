...
"""Verify that starting deimos with -h works as expected."""

from test_framework.test_framework import DeimOSTestFramework
from test_framework.util import assert_equal

class HelpTest(DeimOSTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deimos with -h for help text")
        ...
        self.log.info("Start deimos with -version for version information")
        ...
        self.log.info("Start deimosd with -fakearg to make sure it does not start")
