...
By default, deimosd will dump mempool on shutdown and
...
class MempoolPersistTest(DeiMosTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give deimosd a second to reload the mempool
        ...
        self.log.debug("Prevent deimosd from writing mempool.dat to disk. Verify that `savemempool` fails")
