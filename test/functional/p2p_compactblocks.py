...
# TestNode: A peer we use to send messages to deimosd, and store responses.
...
class CompactBlocksTest(DeiMosTestFramework):
    ...
    # This test actually causes deimosd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that deimosd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for deimosd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # deimosd will not send blocktxn responses for blocks whose height is
