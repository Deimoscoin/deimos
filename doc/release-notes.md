...
DeiMos Core version 0.14.0 is now available from:
...
- #8722 `bb843ad` deimos-cli: More detailed error reporting (laanwj)
...
- #8830 `ef0801b` test: Add option to run deimos-util-test.py manually (jnewbery)
- #8881 `e66cc1d` Add some verbose logging to deimos-util-test.py (jnewbery)
...
- #9023 `774db92` Add logging to deimos-util-test.py (jnewbery)
- #9065 `c9bdf9a` Merge `doc/unit-tests.md` into `src/test/README.md` (laanwj)
- #9069 `ed64bce` Clean up bctest.py and deimos-util-test.py (jnewbery)
...
- #9691 `fc67cd2` Init ECC context for `test_deimos_fuzzy` (gmaxwell)
...
- #9865 `289204f` Change deimos address in RPC help message (marijnfs)
...
- #8813 `fb24d7e` deimosd: Daemonize using daemon(3) (laanwj)
...
- #8837 `2108911` Allow deimos-tx to parse partial transactions (jnewbery)
- #9204 `74ced54` Clarify CreateTransaction error messages (instagibbs)
- #9265 `31bcc66` deimos-cli: Make error message less confusing (laanwj)
...
- #8883 `d5d4ad8` Add all standard TXO types to deimos-tx (jnewbery)
