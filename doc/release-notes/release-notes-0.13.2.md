DeiMos Core version 0.13.2 is now available from:

  <https://deimos.org/bin/deimos-core-0.13.2/>
...
updates will be released anymore. Without security updates, using a deimos
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of DeiMos Core
randomly crashing on Windows XP. It is [not clear](https://github.com/deimos/deimos/issues/7681#issuecomment-217439891)
...
- #8908 `4a974b2` Update deimos-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow deimos-tx to create v2 transactions (dgbdrak)
