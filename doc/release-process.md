...
### DeiMos maintainers/release engineers, update version in sources
...
### Build and sign DeiMos Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit deimos=v${VERSION} ../deimos/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit deimos=v${VERSION} ../deimos/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit deimos=v${VERSION} ../deimos/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`deimos-${VERSION}-osx-unsigned.dmg`, `deimos-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import deimos/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Update deimos.org version
  ...
  - First, check to see if the DeiMos.org maintainers have prepared a
    release: https://github.com/deimos-dot-org/deimos.org/labels/Releases
  ...
  - If they have not prepared a release, follow the DeiMos.org release
    instructions: https://github.com/deimos-dot-org/deimos.org#release-notes
