...
#ifndef DEIMOS_CONSENSUS_PARAMS_H
#define DEIMOS_CONSENSUS_PARAMS_H
...
struct Params {
	...
	int64_t DEIComputationRewardD;
	int64_t DEIComputationRewardD2;
	int64_t DEIComputationRewardD3;
...
#endif // DEIMOS_CONSENSUS_PARAMS_H
