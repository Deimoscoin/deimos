...
QString DeiMosUnits::longName(int unit)
{
    switch(unit)
    {
    case DEI: return QString("DEI");
    case mDEI: return QString("mDEI");
    case uDEI: return QString::fromUtf8("µDEI (digis)");
    default: return QString("???");
    }
}

QString DeiMosUnits::shortName(int unit)
{
    switch(unit)
    {
    case uDEI: return QString::fromUtf8("bits");
...
QString DeiMosUnits::description(int unit)
{
    ...
    case uDEI: return QString("Micro-DeiMoss (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
QString DeiMosUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+DeiMosUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
