...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("deimos://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'deimos://' is not a valid URI. Use 'deimos:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(DEIMOS_IPC_PREFIX, Qt::CaseInsensitive)) // deimos: URI
    {
