...
#ifndef DEIMOS_QT_DEIMOSUNITS_H
#define DEIMOS_QT_DEIMOSUNITS_H
...
/** DeimOS unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DeimOSUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DeimOSUnits(QObject *parent);

    /** DeimOS units.
      @note Source: https://en.deimos.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DEI,
...
typedef DeimOSUnits::Unit DeimOSUnit;

#endif // DEIMOS_QT_DEIMOSUNITS_H
