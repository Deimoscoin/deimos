...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/deimos/deimos/pull/10340, but that change has been
    // postponed until after https://github.com/deimos/deimos/pull/10244 to
 ...
 * https://deimostalk.org/?topic=54527, or
 * https://github.com/deimos/deimos/pull/1393.
 */
...
int CMerkleTx::GetBlocksToMaturity() const
{
    if (!IsCoinBase())
        return 0;
    return std::max(0, (COINBASE_MATURITY_2+1) - GetDepthInMainChain());
}
