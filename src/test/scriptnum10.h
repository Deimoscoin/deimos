...
#ifndef DEIMOS_TEST_SCRIPTNUM10_H
#define DEIMOS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DeiMos Core 0.10.0, for cross-comparison.
 */
public:
