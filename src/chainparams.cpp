...
// Copyright (c) 2017-2018 The DeiMos Core developers
...
public:
	...
	consensus.DEIComputationRewardD3 = 1067702;
        ...
        vSeeds.emplace_back("deimospay.com");
        ...
        chainTxData = ChainTxData{
            1531721377, // * UNIX timestamp of last known number of transactions
            503200,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.nLocalDifficultyAdjustment = 4;
        // DeiMos Hard Fork Block Heights
        consensus.multiAlgoDiffChangeTarget = 120;
        consensus.alwaysUpdateDiffChangeTarget = 200;
        consensus.workComputationChangeTarget = 320;
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 14112;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetSpacing = 10 * 60;
        consensus.nTargetTimespan =  0.10 * 24 * 60 * 60;
        consensus.nTargetSpacing = 60;
        consensus.nInterval = consensus.nTargetTimespan / consensus.nTargetSpacing;
        consensus.nDiffChangeTarget = 67;
        ...
        consensus.nLocalTargetAdjustment = 4;
        consensus.nLocalDifficultyAdjustment = 4;
        consensus.multiAlgoDiffChangeTarget = 145;
