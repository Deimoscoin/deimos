...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " deimos-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  deimos-tx [options] <hex-tx> [commands]  Update hex-encoded deimos transaction\n" +
            "or:     deimos-tx [options] -create [commands]   Create hex-encoded deimos transaction\n" +
            "\n";
