...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s deimos-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  deimos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded deimos transaction") + "\n" +
              "  deimos-tx [options] -create [commands]   " + _("Create hex-encoded deimos transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CDeiMosAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CDeiMosAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded deimos transaction
